...
<body style="overflow-y:hidden;background-color: #EEEEEE">
	<div id="porWin" class="panel panel-primary" style="margin-bottom: 0px; overflow-x: hidden;display:none">
		<div class="panel-heading">
			<span style="font-size: medium;">欢迎访问免费wifi</span> <span class="pull-right" style="font-size: medium;"></span>
		</div>
		<div class="panel-body" style="padding: 0px">
			<div class="row">
				<div class="img-responsive" style="text-align: center;">
					<a id="advUrl" href="#"> 
						<img id="adv"	style="height: 300px; width: 100%;" src=""> 
					</a>
				</div>
			</div>
			<div class="container"
				style="padding-top: 20px; margin-left: auto; margin-right: auto; width: 1000px">
				<div class="row">
					<div class="col-sm-4 col-sm-offset-2 col-md-6 col-md-offset-3" style="text-align: left; margin: 0 0 15px 0px; vertical-align: middle;">
						...
						<span id="errmsg"
							style="font-size: 12px; color: red; text-align: left;"></span>
				...
				<div class="row" style="margin-bottom: 15px;">
					<div id="mobileAuthorization" style="display: block;">
						<div class="col-sm-4 col-md-4" style="text-align: center; vertical-align: middle;">
							<div id="sms" class="col-sm-4 col-md-4" style="float: left; display: none;">
								<img style="width: 50px;" onclick="goSms()" alt="短信认证" src="${root}/resources/image/sms.gif"> 
								<span style="margin-left: 5px; display: block;">短信认证</span>
							</div>
							<div id="weixin" class="col-sm-4 col-md-4" style="float: left; display: none;">
								<img style="width: 50px; margin-left: 20px;" onclick="goWechat()" alt="微信认证" src="${root}/resources/image/wechat.png"> 
					...
					<div id="mobileOneKey" class="col-sm-4 col-md-4" style="text-align: center;display: none;">
						<div style="float: left;">
							...
							<br/><span style="margin-top:10px;margin-left: 20px; m display: block;">一键认证</span>
						</div>
					</div>
				</div>
			</div>
	...
	<div id="pcView" style="clear:both; margin: 40px 70px 50px 70px;height: 540px;width: 1230px;display:none;background-color: #FFFFFF">
		...
		<div style="margin-top: 40px;margin-left: 20px">
			...
			<div id="authorization" style="display:none;">
				<!-- 电话号码 -->
				<div id="errorPhone" style="float:left;">
					<div style="float: left;">	
			...
			<!-- 认证消息 -->
			<div style="float:left;">
				<div id="wait" style="display: none;margin-left: 220px;margin-top: 30px;">
