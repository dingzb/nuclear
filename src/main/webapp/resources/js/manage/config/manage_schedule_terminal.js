...
.controller('apTerminialConfTaskCtrl', function($scope, $http) {
    $scope.config = {};
    ...
    function initConfigSelect() {
        //使用模板 另存模板名称
        // $http.get("app/ac/getApCfgSelectItem")
        //     .success(function(data) {
        //         if (data.success) {
        //             $scope.apCfgItems = data.data;
        //         }
        //     });
        $http.post("app/ac/apmanage/getApCfgs",{
                apType:"TERMINAL"
    ...
    $scope.onResetSearch = function() {
        $scope.datagrid.params.terminalType = 0;
